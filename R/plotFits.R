  ...
  function(nlsFitPlotsOutputList,
    ...
    resplot <- ggplot2::ggplot() +
      ...
      ggplot2::facet_wrap(
        ...
        labeller = ggplot2::label_wrap_gen(labels=preds_from_data, multi_line=FALSE),
        ncol = 6
      ) +
    ...
    ciplot <- ggplot2::ggplot(params, ggplot2::aes(col = fragment)) +
      ...
      ggplot2::facet_wrap(adduct ~ term, scale = 'free_x',labeller = ggplot2::label_wrap_gen(labels=preds_from_data, multi_line=FALSE), ncol = 2) +
